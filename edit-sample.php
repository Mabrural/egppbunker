        ...
        if(editSample($_POST) > 0 ) {
            ...
            setTimeout(function () { 
                swal.fire({
                    ...
                    title               : 'Success',
                    text                : 'Sample Receipt successfully updated!',
                    icon                : 'success',
                    timer               : 2000,
            ...
            setTimeout(function () { 
                swal.fire({
                    ...
                    title               : 'Failed',
                    text                : 'Failed to updated Sample Receipt!',
                    icon                : 'error',
                    timer               : 2000,
                    showConfirmButton   : false
                });  
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Edit Sample Receipt</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Edit Sample Receipt</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="truck_or_vessel" value="<?= $sample['truck_or_vessel']?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="cargo" value="<?= $sample['cargo']?>" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="port" value="<?= $sample['port']?>" class="form-control" required>
                                </div>
                            </div>
                        </div>
