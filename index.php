...
if (!isset($_SESSION["login"])) {
  ...
  exit;
    ...
    // $company = query("SELECT COUNT(*) AS total_company FROM company");
    // $totalCompany = $company[0]['total_company'];

    // $employees = query("SELECT COUNT(*) AS total_employees FROM employees");
    // $totalEmployees = $employees[0]['total_employees'];
